<template class="todo bg-dark">
    ...
    <div class="login">
        ...
        <form class="formulario"  id="formul" @submit="login">
            <label>Usuario</label>
            <input type="text" id="input-usuario" @keyup="read" @focus="parar" @blur="seguir" placeholder="seba.developer@gmail.com" autocomplete="off" name="usuario"  v-model="usuario">
            <label>Contraseña</label>
            <input type="password" @focus="pass" @blur="nopas" id="input-clave" v-model="clave" name="clave" placeholder="*******">
    ...
    export default {
        ...
        methods: {
         ...
         async   login(e){
             try {
                  e.preventDefault();
                    await auth.login(this.usuario, this.clave);
                    const user = {
                        email: this.usuario
                        };
